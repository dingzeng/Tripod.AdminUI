          ...
          <template v-for="col in columns">
            <el-table-column v-if="col.type=='_opt'" label="操作" width="150" :key="col.prop">
              <template slot-scope="scope">
                <el-button v-if="col.actions.indexOf('edit') > -1" size="mini" @click="handleEdit(scope.$index, scope.row)">编辑</el-button>
                <el-button v-if="col.actions.indexOf('delete') > -1" size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)">删除</el-button>
              </template>
            </el-table-column>
            <el-table-column 
              v-else
